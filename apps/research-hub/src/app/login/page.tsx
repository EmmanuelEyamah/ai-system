...
import { Search, LogIn, Eye, EyeOff, AlertCircle } from "lucide-react";
      ...
      >
        <div className="text-center mb-8">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 mb-4"
          >
            <Search size={24} className="text-cyan-400" />
          </motion.div>
          <h1 className="text-2xl font-bold text-white mb-1">Research Hub</h1>
          ...
          <div className="bg-white/2 border border-white/5 rounded-2xl p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 rounded-lg bg-white/3 border border-white/6 text-[13px] text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-cyan-500/30 focus:bg-white/4 transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2.5 pr-10 rounded-lg bg-white/3 border border-white/6 text-[13px] text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-cyan-500/30 focus:bg-white/4 transition-all"
                />
                <button
                  type="button"
        ...
        <p className="text-center text-[11px] text-zinc-700 mt-4">
          AI Research Agent &middot; Local access only
        </p>
      </motion.div>
    </div>
  );
